      ...
      children: <Widget>[
        TextField(
          decoration: InputDecoration(
              contentPadding: EdgeInsets.all(10), hintText: 'Pesquisa'),
          onChanged: (text) {}, // professor, eu não consegui seguir daqui...
        ),
        Expanded(
  ...
  Widget _buildRow(BuildContext context, int index, DSIWordPair wordPair) {
    return Dismissible(
      ...
      background: Container(
        ...
        child: Center(
            child:
                Text("Apagando...", style: TextStyle(color: Colors.black87))),
      ),
    );
  }
